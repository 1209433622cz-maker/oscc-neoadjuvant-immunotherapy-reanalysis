...
def draw_gse281729(ax: plt.Axes, df: pd.DataFrame) -> None:
    ...
    ax.text(
        0.00,
        1.005,
        "HPV + second-drug adjusted; HC3 covariance",
...
def draw_interpretation(ax: plt.Axes) -> None:
    ...
    blocks = [
        (0.69, "Response association with timing sensitivity", "GSE281729: the family signal survives timing and matched-null tests; sampling remains response-adaptive", "#1f1f1f"),
