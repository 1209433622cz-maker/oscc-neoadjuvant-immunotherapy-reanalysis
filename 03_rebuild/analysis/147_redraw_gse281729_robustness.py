...
def paired_forest(
    ...
    ax.set_title(title, loc="left", fontsize=8.5, fontweight="bold", pad=12)
    ax.text(0.00, 1.005, subtitle, transform=ax.transAxes, fontsize=6.2, color="#444444", va="bottom")
    style_axis(ax)
...
def main() -> None:
    ...
    ax_c.set_title("Patient influence", loc="left", fontsize=8.5, fontweight="bold", pad=5)
    style_axis(ax_c)
    panel_label(ax_c, "c")
    ...
    ax_d.set_title("Locked-module coverage", loc="left", fontsize=8.5, fontweight="bold", pad=5)
    style_axis(ax_d)
