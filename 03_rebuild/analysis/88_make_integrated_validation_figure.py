...
def draw_interpretation(ax: plt.Axes) -> None:
    ...
    blocks = [
        (
            0.69,
            "Design-limited response association",
            "GSE281729: direction survives score de-duplication, but z-score family effects attenuate after matched-background adjustment",
            "#1f1f1f",
        ),
